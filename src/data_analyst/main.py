...
def run():
    ...
    file_path = input("Enter the path of your CSV file: ").strip()
...
def run_with_trigger():
    ...
    try:
        result = DataAnalyst().crew().kickoff(inputs=inputs)
        return result
    except Exception as e:
        raise Exception(
